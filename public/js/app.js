...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/MainComponent.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/MainComponent.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchLoads: function fetchLoads() {
      var _this = this;
    ...
    submit: function submit() {
      ...
      axios.post('api/load', {
        ...
        console.log(_this2.loads);

        _this2.loads.unshift({
          date: res.data.points[0].date,
          name: res.data.points[0].name,
    ...
    generateSrc: function generateSrc($route) {
      $route = $route.trim();
      $route = $route.split('-');
...
var app = new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
  el: '#app',
  components: {
    App: _components_MainComponent_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MainComponent_vue_vue_type_template_id_3ee370e9___WEBPACK_IMPORTED_MODULE_0__.render),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/MainComponent.vue?vue&type=template&id=3ee370e9&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/MainComponent.vue?vue&type=template&id=3ee370e9& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("main", { staticClass: "pt-10 pb-20" }, [
    _c("div", { staticClass: "container mx-auto px-4" }, [
      _c("h1", { staticClass: "text-2xl font-bold" }, [
        _vm._v("Біржа вантажів"),
      ]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "flex flex-col pt-4 pb-8 gap-y-2 lg:w-2/3 xl:w-1/2" },
        [
          _c(
            "button",
            {
              staticClass:
                "border-none rounded bg-blue-600 text-white font-bold py-2 px-8 inline-block mr-auto",
              on: {
          ...
          _vm._v(" "),
          _c("div", {}, [
            _vm._v("Всього: " + _vm._s(_vm.loads.length) + " вантажів"),
          ]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "w-full border divide-y" },
            [
              _vm._m(0),
              _vm._v(" "),
              _vm._l(_vm.loads, function (load, index) {
                return _c(
                  ...
                  {
                    key: load.id,
                    staticClass: "divide-y flex flex-col",
                    on: {
                      click: function ($event) {
                        _vm.selected = index
                      },
                  ...
                  [
                    _c(
                      "div",
                      {
                        ...
                        class: {
                          "border border-blue-600": _vm.selected == index,
                        },
                      },
                      [
                        _c("div", { staticClass: "w-full grid grid-cols-5" }, [
                          _c("div", { staticClass: "py-1 px-4" }, [
                            _vm._v(_vm._s(load.date)),
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "py-1 px-4 col-span-2" }, [
                            _vm._v(_vm._s(load.name)),
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "py-1 px-4" }, [
                            _vm._v(_vm._s(load.title)),
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "py-1 px-4" }, [
                            _vm._v(_vm._s(load.weight)),
                          ]),
                        ]),
                        _vm._v(" "),
                        _c(
                          ...
                          {
                            staticClass: "h-80",
                            class: { hidden: _vm.selected != index },
                          },
                          [
                            _c("iframe", {
                              staticStyle: { border: "0" },
                              attrs: {
                                src: _vm.generateSrc(load.name),
                                width: "100%",
                                height: "100%",
                                allowfullscreen: "",
                                loading: "lazy",
    ...
    _c(
      ...
      [
        _c(
          "div",
          { staticClass: "bg-white w-1/3 p-5 flex flex-col gap-4 relative" },
          [
            _c(
              "button",
              {
                staticClass: "absolute right-5 top-5 h-4 w-4",
                on: {
                  click: function ($event) {
                    _vm.showModal = !_vm.showModal
                  },
              ...
              [
                _c("span", {
                  staticClass:
                    "bg-gray-300 absolute transform rotate-45 block h-0.5 w-4",
                }),
                _vm._v(" "),
                _c("span", {
                  staticClass:
            ...
            _c("h2", { staticClass: "text-xl font-bold" }, [
              _vm._v("Нове замовлення"),
            ]),
            _vm._v(" "),
            _c(
              "form",
              {
                staticClass: "flex flex-col gap-y-6",
                on: {
              ...
              [
                _c("div", { staticClass: "grid grid-cols-2 gap-4" }, [
                  _c("label", [
                    _c("input", {
                      ...
                      staticClass: "border rounded py-2 px-4 w-full",
                      attrs: {
                        type: "text",
                        name: "from",
                        placeholder: "Звідки",
                  ...
                  _c("label", [
                    _c("input", {
                      ...
                      staticClass: "border rounded py-2 px-4 w-full",
                      attrs: { type: "text", name: "to", placeholder: "Куди" },
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "border-none rounded bg-blue-600 text-white font-bold py-2 px-8 inline-block ml-auto",
                  },
                  [_vm._v("\n                    Додати\n                ")]
                ),
              ]
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "grid grid-cols-5 font-bold" }, [
      _c("div", { staticClass: "py-1 px-4" }, [_vm._v("Дата")]),
      _vm._v(" "),
      _c("div", { staticClass: "py-1 px-4 col-span-2" }, [_vm._v("Маршрут")]),
      _vm._v(" "),
      _c("div", { staticClass: "py-1 px-4" }, [_vm._v("Вантаж")]),
      _vm._v(" "),
      _c("div", { staticClass: "py-1 px-4" }, [_vm._v("Вага")]),
    ])
  },
]
